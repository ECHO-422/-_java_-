...
public class HomePage extends JFrame{
	...
	public HomePage()
	{
		...
		this.yq[0].setText("地区");
		this.yq[1].setText("现存确诊");
		this.yq[2].setText("累计确诊");
		this.yq[3].setText("死亡");
		this.yq[4].setText("治愈");
	...
	public void init()
	{
        ...
        for(int i=0;i<31;i++)
        {
        	txta=Spider.yD[i].addString(txta,12);
        	txta=txta+"\n";
        }
        txtArea.setText(txta);
